...
class OrderLineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line_item" do
    assert_difference("OrderLineItem.count") do
      post order_line_items_url, params: { order_line_item: { due_datetime: @order_line_item.due_datetime, order_id: @order_line_item.order_id, rental_id: @order_line_item.rental_id } }
    end
  ...
  test "should update order_line_item" do
    patch order_line_item_url(@order_line_item), params: { order_line_item: { due_datetime: @order_line_item.due_datetime, order_id: @order_line_item.order_id, rental_id: @order_line_item.rental_id } }
